...
class Node():
    ...
    def __init__(
        ...
        weights : list
            ...
            their outputs (handles the fact that all units are in normalized discharge,
            weights represent their respective fractional area within the Node subcatchment).
        ...
        if len(weights) != len(self._units):
